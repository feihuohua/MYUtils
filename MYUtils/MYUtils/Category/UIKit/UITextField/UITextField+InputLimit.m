...
static const void *UITextField_InputLimitMaxLengthKey = &UITextField_InputLimitMaxLengthKey;

@implementation UITextField (InputLimit)

- (NSInteger)maxLength {
    return [objc_getAssociatedObject(self, UITextField_InputLimitMaxLengthKey) integerValue];
}

- (void)setMaxLength:(NSInteger)maxLength {
    objc_setAssociatedObject(self, UITextField_InputLimitMaxLengthKey, @(maxLength), OBJC_ASSOCIATION_ASSIGN);
