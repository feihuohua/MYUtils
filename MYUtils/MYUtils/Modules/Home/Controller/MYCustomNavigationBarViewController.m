...
//  MYUtils
//
//  Created by sunjinshuai on 2017/8/19.
...
@interface MYCustomNavigationBarViewController ()<UIWebViewDelegate, UIScrollViewDelegate>
...
- (void)setupNavigationBarButtonItem {
    ...
    UIBarButtonItem *shareButton = [UIBarButtonItem barButtonItemWithTarget:self andWithAction:@selector(share:) andWithImage:@"houses_share"];
    ...
    UIBarButtonItem *collectButton = [UIBarButtonItem barButtonItemWithTarget:self andWithAction:@selector(collect:) andWithImage:@"houses_collect_normal"];
    [rightBarButtonItems addObject:collectButton];
    
    self.navigationItem.rightBarButtonItems = rightBarButtonItems;
    
    self.navigationItem.leftBarButtonItem = [UIBarButtonItem barButtonItemWithTarget:self andWithAction:@selector(didTapBackButton) andWithImage:@"hk_navigation_white_back"];
}
