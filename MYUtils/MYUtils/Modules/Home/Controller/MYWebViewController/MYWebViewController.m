...
#import "MYURLInterceptionViewController.h"
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    } else if ([title isEqualToString:@"URLInterception"]) {
        
        MYURLInterceptionViewController *vc = [[MYURLInterceptionViewController alloc] init];
        [self.navigationController pushViewController:vc animated:YES];
