...
//        
//        MYShowTextCellModel *cellModel = [[MYShowTextCellModel alloc]initWithContent:contentArr[i]  contentLines:QSTextInitContentLines isOpen:NO];
...
//    self.view.backgroundColor = [UIColor lightGrayColor];
    ...
    imageView.image = [UIImage iconWithInfo:TBCityIconInfoMake(@"\U0000e60c", 40, [UIColor redColor])];
...
- (CGFloat)tableView:(UITableView *)tableView heightForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    return [MYShowTextViewCell cellHeightWithModel:[self p_modelAtIndexPath:indexPath]];
}
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    MYShowTextViewCell *cell = [tableView dequeueReusableCellWithIdentifier:kShowTextCellReuseIdentifier];
    if (!cell) {
        
        cell = [[MYShowTextViewCell alloc]initWithStyle:UITableViewCellStyleDefault reuseIdentifier:kShowTextCellReuseIdentifier];
...
- (MYShowTextCellModel *)p_modelAtIndexPath:(NSIndexPath *)indexPath{
