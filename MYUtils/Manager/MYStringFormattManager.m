...
@implementation MYStringFormattManager

+ (instancetype)shareManager {
    static MYStringFormattManager *_shareManager;
    static dispatch_once_t onceToken;
    dispatch_once(&onceToken, ^{
        _shareManager = [[MYStringFormattManager alloc] init];
    });
...
- (NSArray *)orderArray:(NSArray *)array orderBy:(NSString *)attributeName {
    ...
    return [NSArray arrayWithArray:backAry];
}
