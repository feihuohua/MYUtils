//
//  QDPerformanceTestingHelper.m
//  QDSpark
//
//  Created by 周大林 on 16/7/30.
...
@implementation QDPerformanceTestingHelper{
...
+ (QDPerformanceTestingHelper *)sharedInstance
{
    static QDPerformanceTestingHelper *_sharedInstance;
    static dispatch_once_t onceToken;
    dispatch_once(&onceToken, ^{
        _sharedInstance = [[QDPerformanceTestingHelper alloc] init];
