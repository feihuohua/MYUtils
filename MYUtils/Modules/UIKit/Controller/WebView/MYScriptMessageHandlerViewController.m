//
//  MYScriptMessageHandlerViewController.m
//  MYUtils
//
...
@interface MYScriptMessageHandlerViewController ()<WKUIDelegate,WKScriptMessageHandler>
...
@implementation MYScriptMessageHandlerViewController
...
- (void)initWKWebView {
    ...
    NSString *htmlPath = [[NSBundle mainBundle] pathForResource:@"messageHandler" ofType:@"html"];
