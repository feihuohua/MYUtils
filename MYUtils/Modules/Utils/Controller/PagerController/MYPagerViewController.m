...
@interface MYPagerViewController ()<TYTabPagerBarDataSource,TYTabPagerBarDelegate,TYPagerControllerDataSource,TYPagerControllerDelegate>
...
- (UIViewController *)pagerController:(TYPagerController *)pagerController controllerForIndex:(NSInteger)index prefetching:(BOOL)prefetching {
    if (index%3 == 0) {
        ...
        MYListViewController *VC = [[MYListViewController alloc]init];
        VC.text = [@(index) stringValue];
        return VC;
    } else {
        MYPagerCollectionViewController *VC = [[MYPagerCollectionViewController alloc]init];
        VC.text = [@(index) stringValue];
        return VC;
    }
}
