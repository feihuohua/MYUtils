 ...
 */
typedef NS_ENUM(NSUInteger, FXStepSliderTextOrientation) {
    /**
     *  Set text labels below slider.
     */
    FXStepSliderTextOrientationDown,
    /**
     *  Set text labels above slider.
     */
    FXStepSliderTextOrientationUp,
};

@interface FXSlider : UIControl
 ...
 */
@property (nonatomic) FXStepSliderTextOrientation labelOrientation;
