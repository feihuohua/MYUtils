...
@interface MYActionSheet ()<UITableViewDataSource, UITableViewDelegate, UIScrollViewDelegate>
...
+ (instancetype)sheetWithTitle:(NSString *)title
             cancelButtonTitle:(NSString *)cancelButtonTitle
                       clicked:(MYActionSheetClickedHandler)clickedHandler
             otherButtonTitles:(NSString *)otherButtonTitles, ... {
    id eachObject;
    va_list argumentList;
    NSMutableArray *tempOtherButtonTitles = nil;
...
- (void)show {
    ...
    MYActionSheetViewController *viewController = [[MYActionSheetViewController alloc] init];
...
#pragma mark - MYActionSheet & UITableView Delegate
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    static NSString *cellID = @"MYActionSheetCell";
    MYActionSheetCell *cell = [tableView dequeueReusableCellWithIdentifier:cellID];
    if (!cell) {
        cell = [[MYActionSheetCell alloc] initWithStyle:UITableViewCellStyleDefault
