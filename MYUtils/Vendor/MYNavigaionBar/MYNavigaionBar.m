...
+ (instancetype)CustomNavigationBar {
    MYNavigaionBar *navigationBar = [[self alloc] initWithFrame:CGRectMake(0, 0, kWRScreenWidth, [MYNavigaionBar navBarBottom])];
...
-(void)updateFrame {
    NSInteger top = ([MYNavigaionBar isIphoneX]) ? 44 : 20;
    NSInteger margin = 0;
