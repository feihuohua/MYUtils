...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  install_resource "${PODS_ROOT}/CATLog/CATLog/CATLog/CATLogFilesViewController.xib"
  install_resource "${PODS_ROOT}/CATLog/CATLog/CATLog/CATLogReviewController.xib"
